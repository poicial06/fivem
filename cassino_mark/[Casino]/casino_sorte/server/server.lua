...
AddEventHandler('casino_luckywheel:getLucky', function()
	...
	local ticket = vRP.getInventoryItemAmount(user_id,'casino_ticket',1)
    ...
    if not isRoll then
        if user_id ~= nil then
            if ticket >= amount then
				...
				local _subRan = math.random(100,100)
                    if _subRan == 1 then
                ...
                SetTimeout(2000, function()
                    ...
                    local source = source
	                local user_id = vRP.getUserId(source)
					local configBase = LoadResourceFile(GetCurrentResourceName(), "config.json")
					local config = json.decode(configBase)
					local vehicle = config.vehicle or ""
					local sql = [[INSERT IGNORE INTO vrp_vehicles(user_id,vehicle,ipva) VALUES(@user_id,@vehicle,@ipva)]]
					...
					vRP.giveInventoryItem(user_id,"casino_token",100)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
					...
					vRP.giveInventoryItem(user_id,"casino_token",200)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
					...
					vRP.giveInventoryItem(user_id,"casino_token",500)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
					...
					vRP.giveInventoryItem(user_id,"casino_token",1000)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
					...
					vRP.giveInventoryItem(user_id,"casino_token",2000)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
					...
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
						message = 'Você ganhou: Parabéns você ganhou R$ 1,000!',
						duration = 5500,
						sound  =  false
					})					
					...
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
						message = 'Você ganhou: Parabéns você ganhou R$ 2,000!',
						duration = 5500,
						sound  =  false
					})					
					TriggerClientEvent('InteractSound_CL:PlayOnOne', source, 'LUCKY_WHEEL_WIN_WIN_CASH', 0.1)
					elseif _priceIndex == 9 then
					vRP.giveInventoryItem(user_id,"dinheirosujo",5000)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
						message = 'Você ganhou: Parabéns você ganhou R$ 5,000!',
						duration = 5500,
						sound  =  false
					})					
					TriggerClientEvent('InteractSound_CL:PlayOnOne', source, 'LUCKY_WHEEL_WIN_WIN_CASH', 0.1)
					elseif _priceIndex == 10 then
					vRP.giveInventoryItem(user_id,"casino_ticket",1)
					TriggerClientEvent('t-notify:client:Custom', source, {
						style = 'success',
						message = 'Você ganhou: Parabéns você ganhou 1 Ticket!',
						duration = 5500,
						sound  =  false
					})
